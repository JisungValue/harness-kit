...
- downstream 프로젝트에서 bootstrap 또는 brownfield adoption으로 하네스를 도입하는 흐름과, 도입 후 task가 어떤 Phase로 진행되는지는 `docs/downstream_harness_flow.md`에서 따로 정리한다.
...
- downstream 하네스 도입/운영 흐름: `docs/downstream_harness_flow.md`
