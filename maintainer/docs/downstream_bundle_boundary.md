...
source repo canonical path는 `bootstrap/docs/*`과 `bootstrap/docs/project_overlay/*` guide/template/workflow이지만, generated bundle에서는 consumer 시작 경로를 유지하기 위해 bootstrap entry docs와 overlay 자산을 계속 `docs/*` 아래로 materialize 한다.
