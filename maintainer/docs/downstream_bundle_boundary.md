...
source repo canonical path는 `downstream/docs/*`, `downstream/scripts/*`, `bootstrap/docs/*`, `bootstrap/docs/project_overlay/*`, `bootstrap/scripts/*`이지만, generated bundle에서는 downstream docs와 overlay 자산은 `docs/*` 아래로, runtime phase-gate 도구는 `downstream/scripts/*` 아래로, bootstrap/adoption 스크립트는 `scripts/*` 아래로 materialize 한다.
