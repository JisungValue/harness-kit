...
- 설치된 downstream 구조와 Phase 흐름 전체는 final runtime path인 `docs/process/downstream_harness_flow.md`를 본다.
...
first success를 확인한 뒤 첫 task를 시작하기 전에는 설치된 프로젝트의 `docs/process/downstream_harness_flow.md`를 한 번 읽고 Phase 1~5, approval gate, 재수행 규칙을 먼저 이해한다.
