...
1. bootstrap output
   ...
   - non-default vendoring이면 `--vendor-path`를 받은 language convention bootstrap reference가 즉시 현지화된다.
...
3. ready for the next session
   ...
   - `validate_overlay_consistency.py`가 runtime traversal contract, decisions index link, process guide/bootstrap reference가 실제로 이어지는지 확인한다.
...
vendor/harness-kit/docs/project_overlay/project_entrypoint_template.md -> docs/entrypoint.md
vendor/harness-kit/docs/project_overlay/decisions_index_template.md -> docs/project/decisions/README.md
vendor/harness-kit/docs/project_overlay/architecture_template.md -> docs/project/standards/architecture.md
vendor/harness-kit/docs/project_overlay/implementation_order_template.md -> docs/project/standards/implementation_order.md
vendor/harness-kit/docs/project_overlay/coding_conventions_project_template.md -> docs/project/standards/coding_conventions_project.md
vendor/harness-kit/docs/project_overlay/quality_gate_profile_template.md -> docs/project/standards/quality_gate_profile.md
vendor/harness-kit/docs/project_overlay/testing_profile_template.md -> docs/project/standards/testing_profile.md
vendor/harness-kit/docs/project_overlay/commit_rule_template.md -> docs/project/standards/commit_rule.md
```

3. 선택한 언어의 bootstrap convention을 `vendor/harness-kit/bootstrap/language_conventions/`에서 골라 `docs/project/standards/coding_conventions_project.md`에 병합한다.
4. `docs/entrypoint.md` 안의 공통 규칙이 `docs/process/harness_guide.md`와 `docs/process/downstream_harness_flow.md`를 가리키는지 확인한다.
...
- `docs/entrypoint.md` 안에 공통 규칙으로 `docs/process/harness_guide.md`와 `docs/process/downstream_harness_flow.md`가 적혀 있다.
...
- 문서는 생겼는데 경로가 이상하면: `docs/entrypoint.md`의 process guide/process flow 경로와 `docs/project/standards/coding_conventions_project.md`의 vendored bootstrap 경로를 먼저 확인한다.
...
- 실제 end-to-end smoke validation 예시는 필요할 때만 `downstream/docs/examples/bootstrap-first-success/validation_report.md`를 본다.
...
- overlay 완료 상태 sample validation 예시는 필요할 때만 `downstream/docs/examples/bootstrap-first-success/overlay_completion_validation_report.md`를 본다.
