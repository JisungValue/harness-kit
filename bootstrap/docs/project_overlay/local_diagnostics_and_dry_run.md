...
- canonical 시작 문서: `bootstrap/docs/quickstart.md`
- 새 프로젝트 first-success 상세판: `bootstrap/docs/project_overlay/first_success_guide.md`
- 기존 프로젝트 read-only 비교: `bootstrap/docs/project_overlay/adopt_dry_run.md`
- 기존 프로젝트 제한적 write: `bootstrap/docs/project_overlay/adopt_safe_write.md`
- unresolved placeholder readiness: `bootstrap/docs/project_overlay/unresolved_decision_validator.md`
- cross-document consistency: `bootstrap/docs/project_overlay/cross_document_consistency_checker.md`
- 사람이 읽는 overlay 완료 판정: `bootstrap/docs/project_overlay/overlay_completion_checklist.md`
