...
- 아래 항목은 허용된다.
  - `docs/project/standards/coding_conventions_project.md`의 일반 `[프로젝트 결정 필요]`
  - `docs/project/standards/quality_gate_profile.md`의 `[프로젝트 결정 필요]`
  - `docs/project/standards/commit_rule.md`의 `[팀 결정 필요]`
- 아래 항목은 금지된다.
  - `docs/project/decisions/README.md`를 포함한 허용 목록 밖 문서의 placeholder
  - `docs/project/standards/coding_conventions_project.md`에서 활성 언어/런타임이 아직 `[프로젝트 결정 필요]`인 상태
  - `docs/project/standards/coding_conventions_project.md`에서 bootstrap 기준 문서가 아직 `[프로젝트 결정 필요]`인 상태
...
- 아래 항목은 금지된다.
  - `docs/project/decisions/README.md`를 포함한 허용 목록 밖 문서의 placeholder
  - `docs/project/standards/coding_conventions_project.md`의 `[프로젝트 결정 필요]`
  - `docs/project/standards/quality_gate_profile.md`의 `[프로젝트 결정 필요]`
...
- 실패 시:
  ...
  - `docs/project/decisions/README.md` 같은 허용 목록 밖 문서의 placeholder도 일반 blocking marker로 출력된다.
...
- unresolved placeholder와 별개로 문서 간 교차 계약도 보려면 `bootstrap/docs/project_overlay/cross_document_consistency_checker.md`를 함께 사용한다.
