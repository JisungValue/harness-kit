...
- `docs/kit_maintenance/downstream_bundle_boundary.md`, `docs/kit_maintenance/downstream_bundle_smoke_validation.md`에 workflow-template shipping과 localized vendoring smoke coverage를 반영한다.
