...
- 구현: `docs/project_overlay/first_success_guide.md`, `bootstrap/docs/quickstart.md`, `docs/project_overlay/local_diagnostics_and_dry_run.md`, `docs/examples/bootstrap-first-success/validation_report.md`, `README.md`를 bootstrap output -> helper -> readiness/consistency -> workflow-template onboarding의 staged confidence path로 정렬함.
