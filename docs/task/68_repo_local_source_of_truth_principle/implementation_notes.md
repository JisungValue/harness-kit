...
- 구현: `docs/harness/common/artifact_policy.md`, `docs/harness/common/audit_policy.md`, `docs/kit_maintenance/audit_policy.md`, task templates, sample examples를 근거 기록과 감사 가능성 기준으로 정렬함.
...
- repo-local 근거: `README.md`, `docs/harness_guide.md`, `docs/how_harness_kit_works.md`, `docs/harness/common/process_policy.md`, `docs/harness/common/artifact_policy.md`, `docs/harness/common/audit_policy.md`, `docs/kit_maintenance/audit_policy.md`, `scripts/check_harness_docs.py`를 기준으로 source-of-truth 선언, 기록 위치, 감사 체크포인트를 맞췄다.
