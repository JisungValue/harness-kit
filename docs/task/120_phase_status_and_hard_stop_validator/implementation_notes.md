...
- repo-local 근거: `docs/harness/common/process_policy.md`, `docs/harness/common/artifact_policy.md`, `docs/harness/common/audit_policy.md`, `docs/harness_guide.md`, `docs/downstream_harness_flow.md`, `bootstrap/docs/quickstart.md`, `maintainer/docs/downstream_bundle_boundary.md`, `tests/test_generate_downstream_bundle.py`를 기준으로 `phase_status.md` lifecycle과 downstream-facing validator 범위를 정했다.
