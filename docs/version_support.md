...
- 현재 최신 GitHub Release: `v0.2.0`
- release URL: `https://github.com/JisungValue/harness-kit/releases/tag/v0.2.0`
...
- `docs/quickstart.md`, `docs/how_harness_kit_works.md`, `docs/project_overlay/local_diagnostics_and_dry_run.md`는 버전 고정 설명 대신 이 문서를 기준으로 현재 범위를 해석한다.
