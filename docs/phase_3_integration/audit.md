...
- 프로젝트 `docs/standard/quality_gate_profile.md`가 현재 Phase 3까지 적용하도록 정의한 필수 test gate가 실행되었거나, 미실행 사유가 남아 있는가
...
- 프로젝트 `docs/standard/quality_gate_profile.md`가 현재 Phase 3까지 적용하도록 정의한 필수 test gate가 누락되지 않았고, 미실행이면 사유가 있는가
