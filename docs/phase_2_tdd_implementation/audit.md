...
- 선택한 레이어 순서와 세분화가 프로젝트 `docs/standard/implementation_order.md`와 정합한가
...
- 선택한 레이어 순서와 세분화 기준이 프로젝트 `docs/standard/implementation_order.md`와 충돌하지 않는가
...
- 선택한 레이어 순서나 세분화가 프로젝트 `docs/standard/implementation_order.md`와 충돌함
- 승인되지 않은 범위 확장이 있음
