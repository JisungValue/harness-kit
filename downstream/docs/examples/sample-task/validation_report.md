...
- 대조한 입력물: `docs/entrypoint.md`, `bootstrap/docs/project_overlay/README.md`
...
- 대조한 입력물: `README.md`, `bootstrap/docs/project_overlay/README.md`, `bootstrap/docs/project_overlay/project_entrypoint_template.md`
  - 실행 방법 또는 확인 방식: `docs/entrypoint.md`, `docs/project/standards/architecture.md`, `docs/project/standards/implementation_order.md`, `docs/project/standards/coding_conventions_project.md`, `docs/project/standards/quality_gate_profile.md`, `docs/project/standards/testing_profile.md`, `docs/project/standards/commit_rule.md` 존재 여부 확인
  - 결과: 최소 세트 정의 완료
  - 실패 또는 미실행 사유: 없음
  - 판정: 정합
...
- 검증 항목: quality gate 실행 여부 기록 확인
  - 대조한 입력물: `docs/project/standards/quality_gate_profile.md`, `validation_report.md`
  - 실행 방법 또는 확인 방식: `docs/project/standards/quality_gate_profile.md` 기준으로 어떤 자동 검증을 실행했는지 또는 왜 미실행인지 기록했는지 수동 검토
...
- 검증 항목: code hygiene 확인 기준 존재 여부
  - 대조한 입력물: `docs/process/common/code_hygiene_policy.md`, `docs/project/standards/quality_gate_profile.md`, `validation_report.md`
...
- 검증 항목: design quality 판단 기준 존재 여부
  - 대조한 입력물: `docs/process/common/design_quality_policy.md`, `docs/project/standards/quality_gate_profile.md`, `validation_report.md`
...
- 검증 항목: performance 판단 기준 존재 여부
  - 대조한 입력물: `docs/process/common/performance_policy.md`, `docs/project/standards/quality_gate_profile.md`, `docs/process/examples/sample-task/implementation_notes.md`
...
- 검증 항목: performance 검증 계획의 Phase 4 반영 여부
  - 대조한 입력물: `docs/process/examples/sample-task/implementation_notes.md`, `docs/process/common/validation_policy.md`, `validation_report.md`
...
- 검증 항목: design quality trade-off 기록 예시 존재 여부
  - 대조한 입력물: `docs/process/examples/sample-task/implementation_notes.md`, `docs/process/common/design_quality_policy.md`, `docs/process/common/performance_policy.md`
...
- 검증 항목: language-specific convention 확인 기준 존재 여부
  - 대조한 입력물: `docs/process/examples/sample-task/coding_conventions_project_example.md`, `plan.md`
...
- 이번 판단의 repo-local 근거: `README.md`, `bootstrap/docs/project_overlay/README.md`, `docs/process/common/*`, sample task 문서를 교차 기준으로 사용했다.
